...
def main():
    ...
    if args.save_model:
        ...
        callbacks = trainer.get_callbacks(model_save_path)
    else:
    ...
    evaluator.plot_training_history(history, f"{args.model_type.upper()} Training History")
    
    # Plot confusion matrix
    evaluator.plot_confusion_matrix(
        y_test, results['predictions'], 
        f"{args.model_type.upper()} Confusion Matrix"
    )
